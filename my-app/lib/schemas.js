...
const schemas = {
  ...
  settings: {
    fields: {
      ...
      // Home tuning
      home: O({}),
      // Dropdown option lists for public & admin forms
      dropdowns: O({}),
    },
  },
};
...
const settingsDefaults = {
  ...
  /* Unified admin-managed dropdown lists (public + admin forms). */
  dropdowns: {
    contactService: {
      options: [
        'تطوير مواقع الويب',
    ...
    quoteTimeline: {
      options: [
        'عاجل جداً — أقل من أسبوعين',
        'قريباً — من أسبوعين إلى شهر',
        'معتدل — من 1 إلى 3 أشهر',
        'متأنٍّ — من 3 إلى 6 أشهر',
        'طويل المدى — أكثر من 6 أشهر',
        'مرن — لا يوجد موعد محدد',
      ],
    ...
    quoteSource: {
      options: [
        '🔍 محرك بحث (Google، Bing...)',
        '📱 وسائل التواصل الاجتماعي',
        '👥 توصية من صديق أو زميل',
        '📢 إعلان ممول',
        '🎙️ مؤتمر أو فعالية',
        '📰 مقال أو مدونة',
        '📧 بريد إلكتروني',
    ...
    currencies: [
      ...
      { symbol: 'ر.س', label: 'ريال سعودي', code: 'SAR' },
